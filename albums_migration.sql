...
VALUES ('Bon Jovi', 'Some album', 1994, 1234532453, 'classic rock, pop');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Christina Aguilera', 'Some other album', 1999, 1005674563, 'classic pop');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Metallica', 'Black album', 1990, 1234556453, 'classic rock, rock');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Eminem', 'New album', 2004, 2334532453, 'Rap, pop');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Styx', 'Old album', 1976, 124532453, 'classic rock, pop');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Bon Jovi', 'Some album', 1994, 1234532453, 'classic rock, pop'),
    ('Christina Aguilera', 'Some other album', 1999, 1005674563, 'classic pop'),
    ('Metallica', 'Black album', 1990, 1234556453, 'classic rock, rock'),
    ('Eminem', 'New album', 2004, 2334532453, 'Rap, pop'),
    ('Styx', 'Old album', 1976, 124532453, 'classic rock, pop');
