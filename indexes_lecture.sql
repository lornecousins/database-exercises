...
# not able to add this insert due to unique constraint on the owner_name
...
INSERT INTO pets (pet_name, owner_name, age) -- ERROR unique constraints allow for the same owner name, or same pet name, but not both
...
VALUES ('Michael Jackson', 'Dangerous', 1991, 27500000, 'pop');